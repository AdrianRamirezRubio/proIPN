...
@Component({
  selector: 'app-trigonometricas-inversas',
  templateUrl: './trigonometricas-inversas.component.html',
  styles: [
  ]
})
export class TrigonometricasInversasComponent implements OnInit {
  htmlOneAsString = `
  
  Polilibro Calculo Integral

  Unidad 1- Trigonometricas e inversas
